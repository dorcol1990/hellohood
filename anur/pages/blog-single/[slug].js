...
export const getStaticProps = async ({ params: { slug } }) => {
  ...
  return {
    props: {
      hellohoodBlog: res.items[0]
    }
  }
}

const BlogSingle = ({hellohoodBlog}) => {

  console.log(hellohoodBlog);
    ...
    return (
        <Fragment>
            ...
            <PageTitle pageTitle={hellohoodBlog.fields.naslov} pagesub={'Blog'} />
                        ...
                        <div className={`col col-lg-8 col-12`}>
                            <div className="wpo-blog-content">
                                <div className="post format-standard-image">
                                    ...
                                    <Image src={'https:' + hellohoodBlog.fields.featureImage.fields.file.url}
                                               width={hellohoodBlog.fields.featureImage.fields.file.details.image.width} 
                                               height={hellohoodBlog.fields.featureImage.fields.file.details.image.height}
                                               alt=""/>
                                    </div>
                                    ...
                                    <h2>{hellohoodBlog.fields.naslov}</h2>
                                    <p>{documentToReactComponents(hellohoodBlog.fields.glavniText)}</p>
                                    {/* <blockquote>
                                ...
                                <div className="tag-share clearfix">
                                    <div className="tag">
                                        <span>Share: </span>
                                        <ul>
                                            <li><Link href="/blog-single/Ipsam-voluptatem">Design</Link></li>
                                            <li><Link href="/blog-single/Ipsam-voluptatem">Plugin</Link></li>
                                            <li><Link href="/blog-single/Ipsam-voluptatem">Photography</Link></li>
                                        </ul>
                                    </div>
                                </div>
